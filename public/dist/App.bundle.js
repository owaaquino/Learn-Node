...
function autocomplete(input, latInput, lngInput) {
	if (!input) return; //skip from running if there is not input on the page
	...
	//if someone hits enter in the address field, dont submit 
...
function loadPlaces(map) {
	...
	_axios2.default.get('/api/stores/near?lat=' + lat + '&lng=' + lng).then(function (res) {
		...
		// create a bounds to make the zoom level until the location of markers
		var bounds = new google.maps.LatLngBounds();
		// infoWindow to display some information on top of the marker 
		...
		// when someone clicks on a marker show the place
